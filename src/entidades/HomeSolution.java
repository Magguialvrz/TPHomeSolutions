...
public class HomeSolution {
	...
	public void fechaFinalizacionProyecto(int idProyecto, Fecha fecha) {
	...
	public lista proyectosActivos() {
	
	}
	
	public lista empleadosNoAsignados() {
	...
	public lista empleadosEnProyecto(int idProyecto) {
